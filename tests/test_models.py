...
def test_models():
    results = {}
    results['report'] = evaluate_model(os.path.join(MODEL_DIR, 'report_classifier.pkl'), X, y)
    results['sentiment'] = evaluate_model(os.path.join(MODEL_DIR, 'sentiment_model.pkl'), X, y)
    return results
